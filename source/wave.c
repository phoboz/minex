...
static const struct mine_data md[MAX_MINE_TYPES]=
{
	...
	// forth level
	{	MINE_TYPE_MAGNETIC | MINE_TYPE_FIREBALL,							2,	400,		MINE_UNCOMMON		},
	{	MINE_TYPE_MAGNETIC | MINE_TYPE_FIREBALL,							1,	420,		MINE_RARE			},
	{	MINE_TYPE_MAGNETIC | MINE_TYPE_FIREBALL,							0,	450,		MINE_VERY_RARE	},

	// fifth level
	{	MINE_TYPE_DIRECTIONAL | MINE_TYPE_CIRCELING,						2,	260,		MINE_COMMON		},
	{	MINE_TYPE_DIRECTIONAL | MINE_TYPE_CIRCELING,						1,	280,		MINE_UNCOMMON		},
	{	MINE_TYPE_DIRECTIONAL | MINE_TYPE_CIRCELING,						0,	300,		MINE_RARE			},

	// sixth level
	{	MINE_TYPE_DIRECTIONAL | MINE_TYPE_FIREBALL | MINE_TYPE_HOMING,		2,	460,		MINE_COMMON		},
	{	MINE_TYPE_DIRECTIONAL | MINE_TYPE_FIREBALL | MINE_TYPE_HOMING,		1,	480,		MINE_UNCOMMON		},
	{	MINE_TYPE_DIRECTIONAL | MINE_TYPE_FIREBALL | MINE_TYPE_HOMING,		0,	500,		MINE_RARE			},

	// seventh level
	{	MINE_TYPE_MAGNETIC | MINE_TYPE_FIREBALL | MINE_TYPE_HOMING,			2,	520,		MINE_UNCOMMON		},
	{	MINE_TYPE_MAGNETIC | MINE_TYPE_FIREBALL | MINE_TYPE_HOMING,			1,	540,		MINE_RARE			},
	{	MINE_TYPE_MAGNETIC | MINE_TYPE_FIREBALL | MINE_TYPE_HOMING,			0,	560,		MINE_VERY_RARE	}
};
